...
public class KeepQuickstart {
     ...
     */
    private static final List<String> KEEP_SCOPES = Collections.singletonList("https://www.googleapis.com/auth/keep");
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        Keep service = new Keep.Builder(HTTP_TRANSPORT, JSON_FACTORY, getOAuthCredentials(HTTP_TRANSPORT))
